...
export const DEFAULT_TEXT_STYLES: Record<string, Record<string, string[]>> = {
  Dsp: {
    B: ['64B-140', '56B-140', '48B-140'],
    N: ['64N-140', '56N-140', '48N-140'],
  },
  Std: {
    B: ['40B-140', '36B-140', '32B-150', '28B-150', '26B-150', '24B-150', '22B-150', '20B-150', '18B-160', '16B-170', '16B-175'],
    N: ['40N-140', '36N-140', '32N-150', '28N-150', '26N-150', '24N-150', '22N-150', '20N-150', '18N-160', '16N-170', '16N-175'],
  },
  Dns: {
    B: ['16B-130', '16B-120', '14B-130', '14B-120'],
    N: ['16N-130', '16N-120', '14N-130', '14N-120'],
  },
  Oln: {
    B: ['16B-100', '14B-100'],
    N: ['16N-100', '14N-100'],
