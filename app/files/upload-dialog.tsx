      ...
      <DialogContent className="max-w-2xl pt-5.5 px-6 pb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="content" placeholder="設定ファイルの内容を貼り付けてください..." value={content} onChange={(e) => setContent(e.target.value)} disabled={isLoading} className="h-48 font-mono text-sm" />
          </div>
