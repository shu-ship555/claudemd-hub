    ...
    <header className="sticky top-0 z-50 h-14 bg-card/95 backdrop-blur-xl backdrop-saturate-150 border-b border-border">
      <div className="max-w-7xl mx-auto px-6 h-full pt-1 pb-2 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-5">
          ...
          <NavLink href="/agent">AGENT.md</NavLink>
          <NavLink href="/design">DESIGN.md</NavLink>
          {isLoggedIn && <NavLink href="/files">設定ファイル管理</NavLink>}
          <NavLink href="https://shumiyata.com/contact/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
            お問い合わせ
